...
namespace Kyber
{
    ...
    public class CompoundTable : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            // CompoundIDs compoundID, States state, string commonName, float density, float volume, bool stable, string chemicalFormula, resources path, scale, component atoms
            ...
            compoundTable.Add(CompoundIDs.N, new CompoundData(States.Gas, "Nitrogen", PLACEHOLDER, PLACEHOLDER, true, "N2", "CompoundSpheres/AirSphere/AirSphere", .4f, "N"));
            compoundTable.Add(CompoundIDs.O, new CompoundData(States.Gas, "Oxygen", PLACEHOLDER, PLACEHOLDER, true, "O2", "CompoundSpheres/AirSphere/AirSphere", .4f, "O"));
            compoundTable.Add(CompoundIDs.CarbonDioxide, new CompoundData(States.Gas, "Carbon Dioxide", PLACEHOLDER, PLACEHOLDER, true, "CO2", "CompoundSpheres/AirSphere/AirSphere", .4f, "C O"));
