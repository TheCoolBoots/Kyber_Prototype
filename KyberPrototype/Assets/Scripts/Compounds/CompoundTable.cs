...
namespace Kyber
{
    ...
    public class CompoundTable : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            // compoundTable.Add(CompoundIDs.H, new CompoundData(States.Gas, "Hydrogen Gas", .002, 300, true, "H(1)"));
            ...
            compoundTable.Add(CompoundIDs.PureWater, new CompoundData(States.Liquid, "Water", 1.0, 1.0, true, "H2O", "WaterSphere"));
        }
    }
}
