...
namespace Kyber
{
    ...
    {
        public GameObject leftController;        //left controller target transform
        public GameObject rightController;       //right controller target transform
        ...
        void Start()
        {
            leftControllerStart = leftController.transform.localPosition;
            rightControllerStart = rightController.transform.localPosition;
        ...
        void FixedUpdate()
        {
            ...
            {
                Vector3 controllerDiff = leftController.transform.localPosition - leftControllerStart;
            ...
            else
            {
                ...
                Vector3 controllerLerp = Vector3.Lerp(leftController.transform.localPosition, leftControllerStart, Time.fixedDeltaTime * armSpeed);
                manipulatorTransform.localPosition = armLerp;
                leftController.transform.localPosition = controllerLerp;
            ...
            else
            {
                ...
                Vector3 controllerLerp = Vector3.Lerp(rightController.transform.localPosition, rightControllerStart, Time.fixedDeltaTime * armSpeed);
                rightController.transform.localPosition = controllerLerp;
            }
        }
        ...
        public void SetLeftControllerAttached()
        {
            leftControllerEquipped = true;
        }
        public void SetLeftControllerDetached()
        {
            leftControllerEquipped = false;
        }

        public void SetRightControllerAttached()
        {
            rightControllerEquipped = true;
        }
        public void SetRightControllerDetached()
        {
            rightControllerEquipped = false;
        }
    }
